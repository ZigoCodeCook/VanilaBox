...
(function($){
  ...
  class ProductPrice {
      ...
      insertPresentmentPrices($price, presentment_prices) {
          ...
          if(sale) {
              let formatedCompareAtPrice = Number(compare_at_price).toLocaleString('en-US', {style: 'currency', currency: Shopify.currency.active});
          ...
          let formatedPrice = Number(price).toLocaleString('en-US', {style: 'currency', currency: Shopify.currency.active});
